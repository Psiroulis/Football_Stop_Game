...
public class TeamsEntity {
    ...
    public static TeamsEntity[] populateData() {
        return new TeamsEntity[]{
                ...
                new TeamsEntity("Peru", 68, 1,2),
                new TeamsEntity("Ecuador", 68, 1,2),
                new TeamsEntity("Venezuela", 63, 1,2),
                new TeamsEntity("Bolivia", 68, 1,2),
                new TeamsEntity("Panamas", 53, 1,2),
                new TeamsEntity("Honduras", 55, 1,2),
                new TeamsEntity("Costa Rica", 70, 1,2),
                new TeamsEntity("Puerto Rico", 55, 1,2),
                //Copa Africa TEams
                new TeamsEntity("Nigeria",80 ,0 ,3),
                new TeamsEntity("Egypt",85 , 0,3),
                new TeamsEntity("Ivory Coast",88 ,0 ,3),
                new TeamsEntity("Cameroon",88 ,0 ,3),
                new TeamsEntity("Morocco", 80, 1,3),
                new TeamsEntity("Tunisia",70 ,1 ,3),
                new TeamsEntity("Zimbabwe",73 ,1 ,3),
                new TeamsEntity("Ghana",90 ,1 ,3),
                new TeamsEntity("Angola",73 ,1 ,3),
                new TeamsEntity("Mali",68 ,1 ,3),
                new TeamsEntity("Togo",68 ,1 ,3),
                new TeamsEntity("Mozambique",63 ,1 ,3),
                new TeamsEntity("Burkina Faso",55 ,1 ,3),
                new TeamsEntity("Congo",50 ,1 ,3),
                new TeamsEntity("Kenya",55 ,1 ,3),
                new TeamsEntity("Ethiopia",50 ,1 ,3),
